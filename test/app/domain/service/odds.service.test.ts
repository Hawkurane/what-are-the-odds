...
describe('RouteDomainService', () => {
  ...
  describe('travel', () => {
    it('should compute the travel', async () => {
      ...
      const result: string[] = await service.getDailyTravelLog(
        milleniumFalcon,
        ['Tatooine', 'Hoth', 'Endor'],
      );
  ...
  describe('getAllPlanets', () => {
    it('should get all planets', async () => {
      ...
      // When Then
      await expect(service.getAllPlanets()).resolves.toStrictEqual([
        'Tatooine',
        'Dagobah',
        'Endor',
        'Hoth',
  ...
  describe('getOddsForEmpirePatrol', () => {
    beforeEach(() => {
      routes.getAllTravels.mockResolvedValue(stubAllRoutes);
      routes.getTravelTime
        .calledWith('Tatooine', 'Dagobah')
        .mockResolvedValue(6);
    ...
    describe('Example 1', () => {
      it('should return 0', async () => {
        ...
        // When
        const result = await service.getOddsForEmpirePatrol(
          milleniumFalconStub,
          empire,
        );
